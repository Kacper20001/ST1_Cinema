...
using Entity = SzkolenieTechniczne.Cinema.Storage.Entities;
...
namespace SzkolenieTechniczne.Cinema.Service.Command.Movie.Add
{
    public sealed class AddMovieCommandHandler : ICommandHandler<AddMovieCommand>
    {
        ...
        public Result Handle(AddMovieCommand command)
        {
            ...
            var movie = new Entity.Movie(command.Name, command.Year, command.SeanceTime, command.Description, command.CategoryId);
        ...
        */
        public Result Handle(AddMovieCommand command)
        {
            ...
            var movie = new Entity.Movie(command.Name, command.Year, command.SeanceTime,
